...
int main(int argc, char *argv[])
{
	...
	float       mbf = 0.0;
        ...
        //mudar aqui o metodo
        printf("Escolhe o metodo que queres: 0-TC_INIT_POP, 1-TC_SOL_FINAL, 2-Ambos: ");
        scanf("%d", &metHibrido);
	...
	for (r=0; r<runs; r++)
	{
		...
		pop = init_pop(EA_param, metHibrido ,mat);
		...
		// Escreve resultados da repeti��o que terminou
                ...
                if(metHibrido==TC_SOL_FINAL || metHibrido == AMBOS)
                    TrepaColinasAutomatico(EA_param.numGenes,200, mat, best_run.p);
